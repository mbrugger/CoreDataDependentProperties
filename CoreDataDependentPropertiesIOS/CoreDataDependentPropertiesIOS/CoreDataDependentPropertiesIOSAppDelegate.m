//
//  CoreDataDependentPropertiesIOSAppDelegate.m
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CoreDataDependentPropertiesDataModel" withExtension:@"mom"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CoreDataDependentPropertiesIOS.sqlite"];
