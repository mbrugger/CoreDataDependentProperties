//
//  CustomerInvoicesTableViewController.m
...
@implementation CustomerInvoicesTableViewController
...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *backButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(back)];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = invoice.invoiceNumber;
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%.2f", invoice.discountedInvoiceSum.doubleValue];
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Invoice" inManagedObjectContext:self.managedObjectContext];
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"invoiceNumber" ascending:NO];
    NSArray *sortDescriptors = [[NSArray alloc] initWithObjects:sortDescriptor, nil];
    
    [fetchRequest setSortDescriptors:sortDescriptors];
    
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"customer = %@", self.customer];
